...
const BoAdminCompanyTypeList = [AclActionType.FULL, AclActionType.BACK_OFFICE, AclActionType.SYSTEM_ADMIN]
const CompanyTypeList = [AclActionType.FULL, AclActionType.PARTIAL, AclActionType.OWNER]
...
export const PERMISSION_AIRLINE_LIST: Record<number, ActionDescription> = {
  ...
  [PERMISSION.INTERNAL_AIRLINE.EDIT_PASSENGER]: {
    ...
    enableType: false,
    description: 'Update passenger information in MMP, not effect to airline system'
  },
...
export const PERMISSION_TEMPLATE: Record<number, ActionDescription> = {
  ...
  [PERMISSION.TEMPLATE.BACK_OFFICE_REVIEW]: {
    ...
    name: "Review & Approve",
    description: "This action using only for Back Office approve or reject template.",
    enableType: true,
    listType: BoAdminTypeList
  },
}
...
export const PERMISSION_BULK_CAMPAIGN: Record<number, ActionDescription> = {
  [PERMISSION.BULK_CAMPAIGN.READ]: {
    ...
    name: "Read",
    description: "View list bulk campaign, admin or BO can user all bulk campaign of other company for support.",
    enableType: true
  },
...
export const PERMISSION_BLACK_LIST: Record<number, ActionDescription> = {
  ...
  [PERMISSION.BLACK_LIST.GLOBAL]: {
    ...
    description: "Create, Update, Delete global black list, apply for whole system, only for BO or Admin",
    enableType: true,
    listType: BoAdminTypeList
  },
}
 ...
 */
export const PERMISSION_TEMPLATE_LIBRARY_LIST: Record<number, ActionDescription> = {
...
export const PERMISSION_TICKET_CATEGORY_LIST: Record<number, ActionDescription> = {
