import {
  createPreSignedUrl,
  downloadS3Url,
  getAwsKeyInfo, getAwsUrlInfo, getS3UrlKey,
...
describe('s3.service.specs.ts', () => {
  ...
  it('Get S3 URL info', async () => {
    console.log(await getAwsUrlInfo('https://ap-southeast-1-dev-peacom.s3.ap-southeast-1.amazonaws.com/files/contactimportsamplefullxlsx.xlsx'));
  });
});
